<div class="row" style="height: 90px; align-items: center;">
    <div class="col-md-10">
        <h2 style="font-weight: 400;">All Tags</h2>
    </div>
...
<div class="row" style="border-bottom-style: groove;padding-bottom: 10px;border-width: 1px;">
    <div class="col-md-5">
        <!-- <div style="font-family: cursive; font-size: 24px;">All Tags</div> -->
    </div>
    <div class="col-md-7" style="text-align: right;">
        <div class="btn-group" role="group">
            <a href="?filter=popular"><button type="button" class="btn btn-outline-secondary">Popular</button></a>
            <a href="?filter=new"><button type="button" class="btn btn-outline-secondary">New</button></a>
